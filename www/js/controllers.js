...
angular.module('starter.controllers', ['ionic','ngCordova'])
    ...
    .controller('LoginCtrl', function($scope, $state, $cordovaPush, $rootScope) {
                ...
                if (statusCode == 200) {
                    if(ionic.Platform.isIOS()) {
                        ...
                        $cordovaPush.register(iosConfig).then(function (deviceToken) {
                            ...
                            sdk.registerDeviceForPushNotification(deviceToken, "iOS", null);
                        ...
                        $cordovaPush.register(androidConfig).then(function(result) {
                            // Success
                            alert(result);
                            sdk.registerDeviceForPushNotification(result, "Android", null);
                        }, function(err) {
                            // Error
                        });
                    }
    ...
    .controller('MatchesCtrl', function($scope, $state, $rootScope, $timeout, $ionicModal, $cordovaGeolocation, $cordovaSocialSharing) {
        ...
        $scope.share = function () {
            $cordovaSocialSharing.share('Digital Signature Maker', null /* img */, 'https://play.google.com/store/apps/details?id=com.prantikv.digitalsignaturemaker', null, function(errormsg){alert("Error: Cannot Share")});
        }
...
>>>>>>> origin/master
    ...
    .controller('AccountCtrl', function($scope, $state, $rootScope, $ionicPopover, $cordovaPush) {
                ...
                if (statusCode == 200) {
                    ...
                    $cordovaPush.unregister({}).then(function(result) {
                        ...
                        $cordovaPush.register({}).then(function (deviceToken) {
                            // Success -- send deviceToken to server, and store for future use
                            console.log("deviceToken: " + deviceToken);
                            sdk.unregisterDeviceFromPushNotification(deviceToken, "iOS", null);
